...
const onReplay = async (user, isAuthenticated, getAccessTokenSilently) => {  
  const score = parseInt(document.querySelector(".wpm b").innerHTML);
  //send to backend on 3000 using auth0  access token as bearer auth
      ...
      <div className="wrapper">
        <div className="content-box">
          ...
          <div className="content">
            ...
            <button
              type="button"
              onClick={() => onReplay(user, isAuthenticated, getAccessTokenSilently)}
              onKeyDown={(ev) => {
                console.log({ ev });
              }}
            >
